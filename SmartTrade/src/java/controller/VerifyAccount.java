...
//            responseObject.addProperty("message", "Email not found.");
            ...
            if (verification.isEmpty()) {
                responseObject.addProperty("message", "verification code can not be empty !");
            } else if (c1.list().isEmpty()) {
                ...
                responseObject.addProperty("message", "Verification succesfull!");
