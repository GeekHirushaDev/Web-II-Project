...
public class MyAccount extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (firstName.isEmpty()) {
            ...
            responseObject.addProperty("message", "Address line 1 cannot be empty");
        } else if (lineTwo.isEmpty()) {
            responseObject.addProperty("message", "Address line 2 cannot be empty");
            ...
            responseObject.addProperty(
                    "message",
                    "The password must contains at least uppercase, lowercase,"
            ...
            responseObject.addProperty(
                    "message",
                    "Confirmed password does not matching entered new password!"
            );
        } else {
